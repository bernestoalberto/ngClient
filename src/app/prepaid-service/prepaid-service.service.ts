...
export class PrepaidService {
  ...
  public getPrepaid(): Observable<any> {
  ...
  public getPrepaidFireBaseDB(): Observable<DocumentChangeAction<any>[]> {
  ...
  public getPrepaidByPrepaidNo(id): Observable<any> {
    return this.http.get(`${BASE_URL}/getPrepaidById:${id}`, httpOptions).pipe(
      map((response: HttpResponse<any>) => response),
      this.backoff(3, 250),
      debounceTime(5000),
      distinctUntilChanged(),
  ...
  public createPrepaid(payload: {}): Observable<any> {
  ...
  public updatePrepaid(payload): Observable<any> {
  ...
  public deletePrepaid(id): Observable<any> {
